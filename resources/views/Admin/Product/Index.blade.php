          ...
          <div class="card">
            <div class="card-header card-header-primary card-header-icon" style="margin-top: -15px;">
              <div style="background-color: #04A55B; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                <h4>Manage Product
                  <a href="{{route('Admin/Product/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#04A55B; box-shadow:none">Add New</a></h4>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table id="datatables" class="table table-no-bordered" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight: bold;">SubCategory</th>
              ...
              @foreach($data as $row)
                     <tr>
                        ...
                        <form action="{{route('Admin/Product/EditSession')}}" method="post">
                          {{csrf_field()}}
