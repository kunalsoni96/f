          ...
          <div class="card">
            <div class="card-header card-header-primary card-header-icon" style="margin-top: -15px;">
              <div style="background-color: #04A55B; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                <h4>Manage Product Category
                  <a href="{{route('Admin/MasterSubCategory/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#04A55B; box-shadow:none">Add New</a></h4>
                </div>
              </div>
              <div class="card-body">
              ...
              @foreach($data as $row)
                     <tr>
                        ...
                        <form action="{{route('Admin/MasterSubCategory/EditSession')}}" method="post">
                          {{csrf_field()}}
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="row" style="padding-bottom: 50px;">
          ...
          <div class="col-sm-4">
            <form action="{{route('Admin/MasterSubCategory/Delete')}}" method="post">
              {{csrf_field()}}
