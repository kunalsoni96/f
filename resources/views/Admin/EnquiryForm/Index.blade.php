              ...
              @foreach($data as $row)
                     <tr>
                        ...
                        <form action="{{route('Admin/EnquiryForm/EditSession')}}" method="post">
                          ...
                          <button type="button" rel="tooltip" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right" onclick="delete_function('{{$row->id}}')" style="background-color: #04A55B; padding:10px; margin-left: 20px; padding-left: 15px; box-shadow: none; padding-right: 15px;" >
                            Delete
                          </button>
