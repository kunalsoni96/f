        ...
        <div class="container-min-full-height d-flex justify-content-center align-items-center">
            <div class="login-center">
                <div class="navbar-header text-center mt-2 mb-4">
                    <a >
                        <img alt="" src="{{url('/')}}/public/frontend/img/logo.png" style="height: 130px; ">
                    </a>
                </div>
                ...
                @endif
                                <!-- /.navbar-header -->
                <form action="{{url('/')}}/Admin/Login/Attempt" method="post" id="RegisterValidation">
                    ...
                    <div class="form-group">
                        <button class="btn btn-block btn-lg btn-primary text-uppercase fs-12 fw-600" type="submit" style="background-color: #04A55B; border:none; box-shadow: none;">Login</button>
                    </div>
